 ...
 * Supports various Node.js installation methods (system, nvm, volta, fnm, asdf, etc.)
 *
...
object KnipNodeResolver {
     ...
     * 7. fnm global packages
     * 8. asdf global packages
     */
    ...
    /**
     * Clears the cached paths. Useful for testing or when paths may have changed.
     */
    fun clearCache() {
        cachedNodePath = null
        languageServerPathCache.clear()
    }
}
